...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var lodash_merge__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/merge */ \"./node_modules/lodash/merge.js\");\n/* harmony import */ var lodash_merge__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_merge__WEBPACK_IMPORTED_MODULE_1__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\nriot.tag2('list', '<div>{opts.property.name}</div> {JSON.stringify(get(opts.data, opts.property.path, []), null, 2)} <div each=\"{item, index in get(opts.data, opts.property.path, [])}\"> {JSON.stringify(templateField(opts.property, index), null, 2)} <tree-child data-is=\"{opts.property.template.type}\" property=\"{templateField(opts.property, index)}\" data=\"{data}\"> {console.log(opts.property)} <virtual if=\"{opts.property.children}\"> <tree children=\"{opts.property.children}\" data=\"{parent.data}\"></tree> </virtual> </tree-child> </div> <button type=\"button\" onclick=\"{add}\">Add</button>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\nthis.data = this.opts.data || {};\n\nthis.add = function () {\n  this.triggerDom('add', {\n    name: this.opts.property.path\n  });\n};\n/**\n * Create a field from a template for its parent.\n *\n * TODO: This will likely need to go somewhere else, FormProcessor probably\n *\n * @param {Field} parent   - Parent field with a template\n * @param {number} [index] - Child index\n * @return {Field}\n\t */\n\nthis.templateField = function (parent, index) {\n  let template = parent.template;\n  let field = lodash_merge__WEBPACK_IMPORTED_MODULE_1___default()({}, template);\n  let i;\n  field.parent = parent.path;\n  field.path = [parent.path, template.pathFragment || index].join('.'); // We're done if there are no children\n\n  if (!field.children) return field; // Otherwise we process the children too\n\n  for (i = 0; i < field.children.length; i++) {\n    field.children[i].path = [field.path, field.children[i].pathFragment].join('.');\n  }\n\n  return field;\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list.tag?");
