...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('list', '<div>{opts.property.name}</div> <tree children=\"{opts.property.children}\" data=\"{data}\"> <yield to=\"afterChild\"> <button type=\"button\" onclick=\"{remove}\">Remove</button> </yield> </tree> <button type=\"button\" onclick=\"{add}\">Add</button>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\nthis.data = this.opts.data || {};\n\nthis.add = function () {\n  this.triggerDom('add', {\n    name: this.opts.property.path\n  });\n};\n\nthis.remove = function (event) {\n  //\n  this.triggerDom('remove', {});\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list.tag?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('tree', '<virtual each=\"{child in children}\"> <tree-child if=\"{isVisible(child)}\" data-is=\"{child.type}\" property=\"{child}\" riot-value=\"{get(data, child.path, child.default)}\" data=\"{data}\"> <yield from=\"beforeChild\"></yield> <virtual if=\"{opts.property.children}\"> <tree children=\"{opts.property.children}\" data=\"{parent.data}\"></tree> </virtual> <yield from=\"afterChild\"></yield> </tree-child> </virtual>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\nthis.children = this.opts.children || [];\nthis.depth = parseInt(this.opts.depth) || 0;\nthis.data = this.opts.data || {};\n/**\n * Determine whether a field should be drawn.\n *\n * @param {Field} field\n * @returns {boolean}\n */\n\nthis.isVisible = function (field) {\n  return field && field.type !== 'hidden';\n}; // TODO: Would be amazing to retain and mount custom element tags without data-is\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/tree.tag?");
