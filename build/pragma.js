...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('list', '<div>{opts.property.name}</div> <tree children=\"{opts.property.children}\" data=\"{data}\"></tree> <button type=\"button\" onclick=\"{add}\">Add</button>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\nthis.data = this.opts.data || {};\n\nthis.add = function () {\n  this.triggerDom('add', {\n    name: this.opts.property.path\n  });\n};\n\nthis.rem = function () {// TODO: Find path of removed item (new list item tag would help this)\n  // this.triggerDom('remove', {\n  //\n  // });\n};\n\nthis.on('update', function () {\n  this.data = this.opts.data || {};\n});\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list.tag?");
