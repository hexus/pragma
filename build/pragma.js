...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _list_item_tag__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list-item.tag */ \"./src/tags/input/list-item.tag\");\n/* harmony import */ var _list_item_tag__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_list_item_tag__WEBPACK_IMPORTED_MODULE_1__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\nriot.tag2('list', '<div if=\"{!!get(opts.property, \\'options.showLabel\\')}\">{opts.property.name}</div> <virtual each=\"{child in opts.property.children}\" key=\"path\"> <list-item property=\"{child}\" editable=\"{!!get(opts.property, \\'options.editable\\')}\"></list-item> </virtual> <button type=\"button\" if=\"{!!get(opts.property, \\'options.editable\\')}\" onclick=\"{add}\">Add</button>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\n\nthis.add = function () {\n  if (!lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.editable')) {\n    return;\n  }\n\n  this.triggerDom('add', {\n    name: this.opts.property.path\n  });\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list.tag?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('pragma-table', '<table name=\"{opts.property.path}\"> <thead if=\"{get(opts.property, \\'options.headings\\')}\"> <tr> <th each=\"{heading in get(opts.property, \\'options.headings\\', [])}\"> {heading} </th> </tr> </thead> <tbody> <tr each=\"{row in opts.property.children}\"> <th if=\"{get(opts.property, \\'options.showLabel\\')}\"> {row.name} </th> <td each=\"{child in row.children}\"> <tree-child data-is=\"{child.type}\" property=\"{child}\"> <virtual if=\"{opts.property.children}\"> <tree children=\"{opts.property.children}\" data=\"{parent.data}\"></tree> </virtual> </tree-child> </td> </tr> </tbody> </table>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a; // TODO: Can the <tree> duplication be avoided?\n//       Yielding rows would be great, but seems very tricky given HTML's strictness with tables.\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/pragma-table.tag?");
