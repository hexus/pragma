...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _mixins_edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../mixins/edit */ \"./src/mixins/edit.js\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('number', '<input name=\"{opts.property.path}\" title=\"{opts.property.name}\" min=\"{opts.property.min}\" max=\"{opts.property.max}\" step=\"{opts.property.step}\" riot-value=\"{opts.property.value}\" disabled=\"{opts.property.disabled}\" oninput=\"{edit}\" type=\"{\\'number\\'}\">', '', '', function(opts) {\nthis.mixin(_mixins_edit__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/number.tag?");
