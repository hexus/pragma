...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var lodash_set__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/set */ \"./node_modules/lodash/set.js\");\n/* harmony import */ var lodash_set__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_set__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var lodash_defaultTo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash/defaultTo */ \"./node_modules/lodash/defaultTo.js\");\n/* harmony import */ var lodash_defaultTo__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_defaultTo__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _mixins_domEvent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../mixins/domEvent */ \"./src/mixins/domEvent.js\");\n/* harmony import */ var papaparse__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! papaparse */ \"./node_modules/papaparse/papaparse.min.js\");\n/* harmony import */ var papaparse__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(papaparse__WEBPACK_IMPORTED_MODULE_4__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\n\n\n\nriot.tag2('picker', '<input ref=\"input\" list=\"picker-{_riot_id}-list\" oninput=\"{input}\"> <datalist id=\"picker-{_riot_id}-list\"> <option each=\"{item, key in data()}\" riot-value=\"{getItemValue(item, key)}\"> {getItemDetail(item, key)} </option> </datalist> <button type=\"button\" onclick=\"{add}\" disabled=\"{!value}\"> Add </button>', '', '', function(opts) {\nthis.mixin(_mixins_domEvent__WEBPACK_IMPORTED_MODULE_3__[\"default\"]);\nconsole.log(this);\nvar tag = this;\nthis.value = null;\n\nthis.source = function () {\n  return lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.source');\n};\n\nthis.data = function () {\n  return lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.data', {});\n};\n\nthis.static = function () {\n  return lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.static', false);\n};\n\nfunction parseData(data) {\n  return new Promise(function (resolve) {\n    resolve(papaparse__WEBPACK_IMPORTED_MODULE_4___default.a.parse(data, {\n      delimiter: ',',\n      header: true,\n      dynamicTyping: true\n    }).data);\n  });\n}\n\nfunction updateData(data) {\n  return new Promise(function (resolve) {\n    resolve(lodash_set__WEBPACK_IMPORTED_MODULE_1___default()(tag.opts.property, 'options.data', data));\n  });\n}\n\nthis.loadData = function () {\n  var _this = this;\n\n  return fetch(this.source()).then(function (response) {\n    return response.text();\n  }).then(parseData).then(updateData).catch(function (error) {\n    console.error(\"Error loading data for field '\".concat(_this.opts.property.path, \"'\"), error);\n  });\n};\n\nthis.updateValue = function (value) {\n  // Linear search for the given value, validating that it's in the data\n  // TODO: Use a good autocomplete library, native won't cut it\n  var i;\n  var data = this.data();\n  var keys = Object.keys(data);\n  var item;\n\n  for (i = 0; i < keys.length; i++) {\n    item = data[keys[i]];\n\n    if (this.getItemValue(item, keys[i]) === value) {\n      this.value = item;\n      return;\n    }\n  }\n\n  this.value = null;\n};\n\nthis.getItemValue = function (item, key) {\n  // Use the configured value key, falling back to the item key\n  var valueKey = lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.key');\n  return valueKey ? lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(item, valueKey) : key;\n};\n\nthis.getItemDetail = function (item, key) {\n  var detailKey = lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.detail');\n  return detailKey ? lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(item, detailKey) : null;\n};\n\nthis.input = function (event) {\n  var _this2 = this;\n\n  if (!this.static() && this.source()) {\n    // Load data on input if it isn't static\n    this.loadData().then(function () {\n      _this2.updateValue(event.target.value);\n    });\n  } else {\n    // Update immediately if data is static\n    this.updateValue(event.target.value);\n  }\n};\n\nthis.add = function () {\n  // Only fire an event for a valid selection\n  if (!this.value) {\n    return;\n  } // Fire the event\n\n  var target = lodash_defaultTo__WEBPACK_IMPORTED_MODULE_2___default()(lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.target'), this.opts.property.path);\n  this.triggerDom('add', {\n    name: target,\n    value: this.value\n  }); // Clear the value\n\n  this.value = null;\n  this.refs.input.value = null;\n}; // Load data upfront if configured\n\nthis.on('mount', function () {\n  var _this3 = this;\n\n  this.static() && this.loadData().then(function () {\n    return _this3.update();\n  });\n});\n});\n\n    \n  \n\n//# sourceURL=webpack://%5Bname%5D/./src/tags/input/picker.tag?");
