...
eval("\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    riot.tag2('group', '<div class=\"group-container\"> <span> {opts.property.name} </span> <span> <yield></yield> </span> </div>', 'group .group-container,[data-is=\"group\"] .group-container{ margin: 8px 0; }', '', function(opts) {\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/group.tag?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _list_item_tag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list-item.tag */ \"./src/tags/input/list-item.tag\");\n/* harmony import */ var _list_item_tag__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_list_item_tag__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('list', '<div>{opts.property.name}</div> <virtual each=\"{child in opts.property.children}\" key=\"path\"> <list-item property=\"{child}\"></list-item> </virtual> <button type=\"button\" onclick=\"{add}\">Add</button>', '', '', function(opts) {\n\nthis.add = function () {\n  this.triggerDom('add', {\n    name: this.opts.property.path\n  });\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list.tag?");
