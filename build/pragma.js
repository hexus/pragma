...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _character_general_tag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./character/general.tag */ \"./src/tags/character/general.tag\");\n/* harmony import */ var _character_abilities_tag__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./character/abilities.tag */ \"./src/tags/character/abilities.tag\");\n/* harmony import */ var _character_defense_tag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./character/defense.tag */ \"./src/tags/character/defense.tag\");\n/* harmony import */ var _character_offense_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./character/offense.tag */ \"./src/tags/character/offense.tag\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\n\n\nriot.tag2('character', '<general general=\"{character.general}\"></general> <abilities abilities=\"{character.abilities}\" strict=\"{opts.strict}\"></abilities> <defense defense=\"{character.defense}\" strict=\"{opts.strict}\"></defense> <offense offense=\"{character.offense}\" strict=\"{opts.strict}\"></offense>', '', '', function(opts) {\nthis.character = this.opts.character;\nthis.on('update', function () {\n  this.character = this.opts.character;\n});\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/character.tag?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_set__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/set */ \"./node_modules/lodash/set.js\");\n/* harmony import */ var lodash_set__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_set__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _mixins_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../mixins/util */ \"./src/mixins/util.js\");\n/* harmony import */ var _mixins_util__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_mixins_util__WEBPACK_IMPORTED_MODULE_1__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\nriot.tag2('defense', '<fieldset> <legend>Defense</legend> <p> <label> <span>HP</span> <input name=\"hitPoints.total\" min=\"0\" max=\"1000\" step=\"1\" riot-value=\"{defense.hitPoints.total}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> <input name=\"hitPoints.current\" min=\"-15\" max=\"{defense.hitPoints.total}\" step=\"1\" riot-value=\"{defense.hitPoints.current}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> <input name=\"hitPoints.nonLethalDamage\" min=\"0\" max=\"100\" riot-value=\"{defense.hitPoints.nonLethalDamage}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </p> <p> <label> <span>Damage reduction</span> <input name=\"damageReduction\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.damageReduction}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> <label> <span>Spell resistance</span> <input name=\"spellResistance\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.spellResistance}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> </p> <p> <label> <span>AC</span> <input name=\"armorClass.total\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.total}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> = 10 + <input name=\"armorClass.armorBonus\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.armorBonus}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"armorClass.shieldBonus\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.shieldBonus}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"armorClass.abilityModifier\" min=\"-60\" max=\"60\" step=\"1\" riot-value=\"{defense.armorClass.abilityModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" disabled=\"{opts.strict}\" type=\"{\\'number\\'}\"> + <input name=\"armorClass.sizeModifier\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.sizeModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"armorClass.naturalArmor\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.naturalArmor}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"armorClass.deflection\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.deflection}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"armorClass.miscModifier\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.miscModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"armorClass.tempModifier\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.tempModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </p> <p> <label> <span>Touch</span> <input name=\"armorClass.touch\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.touch}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> <label> <span>Flat-footed</span> <input name=\"armorClass.flatFooted\" min=\"-100\" max=\"100\" step=\"1\" riot-value=\"{defense.armorClass.flatFooted}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> </p> <p each=\"{save, name in defense.saves}\"> <label> <span>{util.titleCase(name)}</span> <input name=\"{\\'saves.\\' + name + \\'.total\\'}\" min=\"0\" max=\"100\" riot-value=\"{save.total}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> = <input name=\"{\\'saves.\\' + name + \\'.base\\'}\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{save.base}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"{\\'saves.\\' + name + \\'.abilityModifier\\'}\" min=\"-60\" max=\"60\" step=\"1\" riot-value=\"{save.abilityModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" disabled=\"{opts.strict}\" type=\"{\\'number\\'}\"> + <input name=\"{\\'saves.\\' + name + \\'.magicModifier\\'}\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{save.magicModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"{\\'saves.\\' + name + \\'.miscModifier\\'}\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{save.miscModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"{\\'saves.\\' + name + \\'.tempModifier\\'}\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{save.tempModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </p> <p> <label> CMD <input name=\"combatManeuverDefense.total\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.combatManeuverDefense.total}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </label> = 10 + <input name=\"combatManeuverDefense.baseAttackBonus\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.combatManeuverDefense.baseAttackBonus}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"combatManeuverDefense.strModifier\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.combatManeuverDefense.strModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" disabled=\"{opts.strict}\" type=\"{\\'number\\'}\"> + <input name=\"combatManeuverDefense.dexModifier\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.combatManeuverDefense.dexModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" disabled=\"{opts.strict}\" type=\"{\\'number\\'}\"> + <input name=\"combatManeuverDefense.miscModifier\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.combatManeuverDefense.miscModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> + <input name=\"combatManeuverDefense.tempModifier\" min=\"0\" max=\"100\" step=\"1\" riot-value=\"{defense.combatManeuverDefense.tempModifier}\" onkeyup=\"{edit}\" onchange=\"{edit}\" type=\"{\\'number\\'}\"> </p> </fieldset>', '', '', function(opts) {\nthis.mixin(_mixins_util__WEBPACK_IMPORTED_MODULE_1___default.a);\nthis.min = Math.min;\nthis.prefix = this.opts.prefix || 'defense.';\nthis.defense = this.opts.defense;\n\nthis.edit = function (event) {\n  // Grab the input element\n  let input = event.target; // Sanitize the value\n\n  input.value = this.util.clamp(input.value, input.min, input.max); // Update the current state\n\n  lodash_set__WEBPACK_IMPORTED_MODULE_0___default()(this.defense, input.name, input.value); // Dispatch an edit event\n\n  this.triggerDom('edit', {\n    input: input,\n    name: this.prefix + input.name,\n    value: input.value\n  });\n};\n\nthis.on('update', function () {\n  this.prefix = this.opts.prefix || 'defense.';\n  this.defense = this.opts.defense;\n});\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/character/defense.tag?");
