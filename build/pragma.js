...
eval("\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    riot.tag2('list-item', '<div> <div style=\"display:inline-block;\"> <tree children=\"{[opts.property]}\"></tree> </div> <div style=\"display:inline-block;\"> <button type=\"button\" onclick=\"{remove}\">Remove</button> </div> </div>', '', '', function(opts) {\nthis.remove = function () {\n  this.triggerDom('remove', {\n    name: this.opts.property.path\n  });\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list-item.tag?");
