...
eval("/**\n * This function is like `arrayIncludes` except that it accepts a comparator.\n *\n * @private\n * @param {Array} [array] The array to inspect.\n * @param {*} target The value to search for.\n * @param {Function} comparator The comparator invoked per element.\n * @returns {boolean} Returns `true` if `target` is found, else `false`.\n */\nfunction arrayIncludesWith(array, value, comparator) {\n  var index = -1,\n      length = array == null ? 0 : array.length;\n\n  while (++index < length) {\n    if (comparator(value, array[index])) {\n      return true;\n    }\n  }\n  return false;\n}\n\nmodule.exports = arrayIncludesWith;\n\n\n//# sourceURL=webpack://pragma/./node_modules/lodash/_arrayIncludesWith.js?");
...
eval("/**\n * This function is like `baseIndexOf` except that it accepts a comparator.\n *\n * @private\n * @param {Array} array The array to inspect.\n * @param {*} value The value to search for.\n * @param {number} fromIndex The index to search from.\n * @param {Function} comparator The comparator invoked per element.\n * @returns {number} Returns the index of the matched value, else `-1`.\n */\nfunction baseIndexOfWith(array, value, fromIndex, comparator) {\n  var index = fromIndex - 1,\n      length = array.length;\n\n  while (++index < length) {\n    if (comparator(array[index], value)) {\n      return index;\n    }\n  }\n  return -1;\n}\n\nmodule.exports = baseIndexOfWith;\n\n\n//# sourceURL=webpack://pragma/./node_modules/lodash/_baseIndexOfWith.js?");
...
eval("/**\n * The base implementation of `_.isNaN` without support for number objects.\n *\n * @private\n * @param {*} value The value to check.\n * @returns {boolean} Returns `true` if `value` is `NaN`, else `false`.\n */\nfunction baseIsNaN(value) {\n  return value !== value;\n}\n\nmodule.exports = baseIsNaN;\n\n\n//# sourceURL=webpack://pragma/./node_modules/lodash/_baseIsNaN.js?");
...
eval("var baseIndexOf = __webpack_require__(/*! ./_baseIndexOf */ \"./node_modules/lodash/_baseIndexOf.js\");\n\n/**\n * Used by `_.trim` and `_.trimStart` to get the index of the first string symbol\n * that is not found in the character symbols.\n *\n * @private\n * @param {Array} strSymbols The string symbols to inspect.\n * @param {Array} chrSymbols The character symbols to find.\n * @returns {number} Returns the index of the first unmatched string symbol.\n */\nfunction charsStartIndex(strSymbols, chrSymbols) {\n  var index = -1,\n      length = strSymbols.length;\n\n  while (++index < length && baseIndexOf(chrSymbols, strSymbols[index], 0) > -1) {}\n  return index;\n}\n\nmodule.exports = charsStartIndex;\n\n\n//# sourceURL=webpack://pragma/./node_modules/lodash/_charsStartIndex.js?");
...
eval("/**\n * A specialized version of `_.indexOf` which performs strict equality\n * comparisons of values, i.e. `===`.\n *\n * @private\n * @param {Array} array The array to inspect.\n * @param {*} value The value to search for.\n * @param {number} fromIndex The index to search from.\n * @returns {number} Returns the index of the matched value, else `-1`.\n */\nfunction strictIndexOf(array, value, fromIndex) {\n  var index = fromIndex - 1,\n      length = array.length;\n\n  while (++index < length) {\n    if (array[index] === value) {\n      return index;\n    }\n  }\n  return -1;\n}\n\nmodule.exports = strictIndexOf;\n\n\n//# sourceURL=webpack://pragma/./node_modules/lodash/_strictIndexOf.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var riot__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\");\n/* harmony import */ var riot__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(riot__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var mixins_domEvent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! mixins/domEvent */ \"./src/mixins/domEvent.js\");\n/* harmony import */ var _tags_old_tag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tags/old.tag */ \"./src/tags/old.tag\");\n/* harmony import */ var _tags_pragma_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tags/pragma.tag */ \"./src/tags/pragma.tag\");\n/* harmony import */ var _services_CharacterFactory__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/CharacterFactory */ \"./src/services/CharacterFactory.js\");\n/* harmony import */ var _services_CharacterSheetProcessor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/CharacterSheetProcessor */ \"./src/services/CharacterSheetProcessor.js\");\n/* harmony import */ var _services_FormProcessor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/FormProcessor */ \"./src/services/FormProcessor.js\");\n/* harmony import */ var _model_functions_abilityModifier__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/functions/abilityModifier */ \"./src/model/functions/abilityModifier.js\");\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./data */ \"./src/data.js\");\n/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./store */ \"./src/store.js\");\n\n\n\n\n\n\n\n\n\n\nvar state = {\n  character: null,\n  sheet: null\n};\nvar app = {\n  events: riot__WEBPACK_IMPORTED_MODULE_0___default.a.observable(),\n  data: _data__WEBPACK_IMPORTED_MODULE_8__[\"default\"],\n  state: state,\n  store: _store__WEBPACK_IMPORTED_MODULE_9__[\"default\"],\n  services: {\n    factory: new _services_CharacterFactory__WEBPACK_IMPORTED_MODULE_4__[\"default\"](),\n    processor: new _services_CharacterSheetProcessor__WEBPACK_IMPORTED_MODULE_5__[\"default\"](),\n    formProcessor: new _services_FormProcessor__WEBPACK_IMPORTED_MODULE_6__[\"default\"](_data__WEBPACK_IMPORTED_MODULE_8__[\"default\"].fields, {\n      abilityModifier: _model_functions_abilityModifier__WEBPACK_IMPORTED_MODULE_7__[\"default\"]\n    }, {// E.g. Custom statistic type?\n    })\n  }\n};\napp.state.sheet = app.store.characters[1];\nriot__WEBPACK_IMPORTED_MODULE_0___default.a.mixin(mixins_domEvent__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\napp.tags = riot__WEBPACK_IMPORTED_MODULE_0___default.a.mount('*', {\n  app: app\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (app);\n\n//# sourceURL=webpack://pragma/./src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Abilities; });\n/* harmony import */ var _Ability__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Ability */ \"./src/model/Ability.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n\n/**\n * Character abilities.\n */\n\nvar Abilities =\n/**\n * Create a new set of character abilities.\n *\n * @param {int} str - Strength score\n * @param {int} dex - Dexterity score\n * @param {int} con - Constitution score\n * @param {int} int - Intelligence score\n * @param {int} wis - Wisdom score\n * @param {int} cha - Charisma score\n */\nfunction Abilities(str, dex, con, int, wis, cha) {\n  _classCallCheck(this, Abilities);\n\n  this.str = new _Ability__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Strength', str);\n  this.dex = new _Ability__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Dexterity', dex);\n  this.con = new _Ability__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Constitution', con);\n  this.int = new _Ability__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Intelligence', int);\n  this.wis = new _Ability__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Wisdom', wis);\n  this.cha = new _Ability__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Charisma', cha);\n};\n\n\n\n//# sourceURL=webpack://pragma/./src/model/Abilities.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Resistances; });\n/* harmony import */ var _Score__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Score */ \"./src/model/Score.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n\n/**\n * A character's resistances.\n */\n\nvar Resistances = function Resistances(cold, fire, electricity, acid) {\n  _classCallCheck(this, Resistances);\n\n  this.cold = new _Score__WEBPACK_IMPORTED_MODULE_0__[\"default\"](cold || 0);\n  this.fire = new _Score__WEBPACK_IMPORTED_MODULE_0__[\"default\"](fire || 0);\n  this.electricity = new _Score__WEBPACK_IMPORTED_MODULE_0__[\"default\"](electricity || 0);\n  this.acid = new _Score__WEBPACK_IMPORTED_MODULE_0__[\"default\"](acid || 0);\n};\n\n\n\n//# sourceURL=webpack://pragma/./src/model/Resistances.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return SavingThrows; });\n/* harmony import */ var _SavingThrow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SavingThrow */ \"./src/model/SavingThrow.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n\n/**\n * A character's saving throws.\n */\n\nvar SavingThrows =\n/**\n * Create a new set of saving throws.\n *\n * @param {Abilities} abilities - Character abilities\n * @param {int}       fort      - Base fortitude save\n * @param {int}       ref       - Base reflex save\n * @param {int}       will      - Base will save\n */\nfunction SavingThrows(abilities, fort, ref, will) {\n  _classCallCheck(this, SavingThrows);\n\n  this.fortitude = new _SavingThrow__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Fortitude', fort, abilities.con);\n  this.reflex = new _SavingThrow__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Reflex', ref, abilities.dex);\n  this.will = new _SavingThrow__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('Will', will, abilities.wis);\n};\n\n\n\n//# sourceURL=webpack://pragma/./src/model/SavingThrows.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return CharacterFactory; });\n/* harmony import */ var _model_Character__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/Character */ \"./src/model/Character.js\");\n/* harmony import */ var _model_General__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/General */ \"./src/model/General.js\");\n/* harmony import */ var _model_Size__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../model/Size */ \"./src/model/Size.js\");\n/* harmony import */ var _model_Abilities__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../model/Abilities */ \"./src/model/Abilities.js\");\n/* harmony import */ var _model_Defense__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/Defense */ \"./src/model/Defense.js\");\n/* harmony import */ var _model_HitPoints__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../model/HitPoints */ \"./src/model/HitPoints.js\");\n/* harmony import */ var _model_ArmorClass__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../model/ArmorClass */ \"./src/model/ArmorClass.js\");\n/* harmony import */ var _model_SavingThrows__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../model/SavingThrows */ \"./src/model/SavingThrows.js\");\n/* harmony import */ var _model_Resistances__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../model/Resistances */ \"./src/model/Resistances.js\");\n/* harmony import */ var _model_CombatManeuverDefense__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../model/CombatManeuverDefense */ \"./src/model/CombatManeuverDefense.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\n\n\n\n\n\n\n\n/**\n * A Character factory.\n */\n\nvar CharacterFactory =\n/*#__PURE__*/\nfunction () {\n  function CharacterFactory() {\n    _classCallCheck(this, CharacterFactory);\n  }\n\n  _createClass(CharacterFactory, [{\n    key: \"create\",\n\n    /**\n     * Create a new Character.\n     *\n     * @param {string} [name] - The character's name.\n     * @returns {Character}\n     */\n    value: function create(name) {\n      var size, abilities;\n      return new _model_Character__WEBPACK_IMPORTED_MODULE_0__[\"default\"](new _model_General__WEBPACK_IMPORTED_MODULE_1__[\"default\"](name || 'Character'), size = new _model_Size__WEBPACK_IMPORTED_MODULE_2__[\"default\"](), abilities = new _model_Abilities__WEBPACK_IMPORTED_MODULE_3__[\"default\"](10, 10, 10, 10, 10, 10), new _model_Defense__WEBPACK_IMPORTED_MODULE_4__[\"default\"](new _model_HitPoints__WEBPACK_IMPORTED_MODULE_5__[\"default\"](), new _model_ArmorClass__WEBPACK_IMPORTED_MODULE_6__[\"default\"](abilities.dex, size, 0, 0, 0, 0, 0, 0), new _model_SavingThrows__WEBPACK_IMPORTED_MODULE_7__[\"default\"](abilities, 0, 0, 0), new _model_Resistances__WEBPACK_IMPORTED_MODULE_8__[\"default\"](), new _model_CombatManeuverDefense__WEBPACK_IMPORTED_MODULE_9__[\"default\"](0, abilities.str, abilities.dex, size, 0, 0)), null, null);\n    }\n  }]);\n\n  return CharacterFactory;\n}();\n\n\n\n//# sourceURL=webpack://pragma/./src/services/CharacterFactory.js?");
...
eval("\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    riot.tag2('list-item', '<div> <div style=\"display:inline-block;\"> <tree children=\"{[opts.property]}\"></tree> </div> <div style=\"display:inline-block;\" if=\"{opts.editable}\"> <button type=\"button\" onclick=\"{remove}\">Remove</button> </div> </div>', '', '', function(opts) {\nthis.remove = function () {\n  if (!this.opts.editable) {\n    return;\n  }\n\n  this.triggerDom('remove', {\n    name: this.opts.property.path\n  });\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list-item.tag?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _list_item_tag__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./list-item.tag */ \"./src/tags/input/list-item.tag\");\n/* harmony import */ var _list_item_tag__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_list_item_tag__WEBPACK_IMPORTED_MODULE_1__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\nriot.tag2('list', '<div class=\"list-container\"> <div if=\"{!!get(opts.property, \\'options.showLabel\\')}\">{opts.property.name}</div> <virtual each=\"{child in opts.property.children}\" key=\"path\"> <list-item property=\"{child}\" editable=\"{editable()}\"></list-item> </virtual> <button type=\"button\" if=\"{editable()}\" onclick=\"{add}\">Add</button> </div>', 'list .list-container,[data-is=\"list\"] .list-container{ margin: 8px auto; }', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\n\nthis.add = function () {\n  if (!this.editable()) {\n    return;\n  }\n\n  this.triggerDom('add', {\n    name: this.opts.property.path\n  });\n};\n\nthis.editable = function () {\n  return !!lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.editable');\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/list.tag?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('pragma-table', '<table name=\"{opts.property.path}\"> <thead if=\"{get(opts.property, \\'options.headings\\')}\"> <tr> <th each=\"{heading in get(opts.property, \\'options.headings\\', [])}\"> {heading} </th> </tr> </thead> <tbody> <tr each=\"{row in opts.property.children}\" key=\"path\"> <th if=\"{get(opts.property, \\'options.showLabel\\')}\"> {row.name} </th> <td each=\"{child in row.children}\" key=\"path\"> <tree-child data-is=\"{child.input}\" property=\"{child}\"> <tree if=\"{opts.property.children}\" children=\"{opts.property.children}\"></tree> </tree-child> </td> </tr> </tbody> </table>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a; // TODO: Can the <tree> duplication be avoided?\n//       Yielding rows would be great, but seems very tricky given HTML's strictness with tables.\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/pragma-table.tag?");
...
eval("\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    riot.tag2('tree', '<virtual each=\"{child in opts.children}\" key=\"path\"> <tree-child if=\"{isVisible(child)}\" data-is=\"{child.input}\" property=\"{child}\"> <tree if=\"{opts.property.children}\" children=\"{opts.property.children}\"></tree> </tree-child> </virtual>', '', '', function(opts) {\n/**\n * Determine whether a field should be displayed.\n *\n * @param {Field} field\n * @returns {boolean}\n */\nthis.isVisible = function (field) {\n  return field && field.type !== 'hidden';\n}; // TODO: Would be amazing to retain and mount custom element tags without data-is\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/tree.tag?");
