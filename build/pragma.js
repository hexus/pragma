...
eval("\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    riot.tag2('number', '<input name=\"{opts.property.path}\" min=\"{opts.property.min}\" max=\"{opts.property.max}\" step=\"{opts.property.step}\" riot-value=\"{opts.riotValue}\" disabled=\"{!!opts.property.derivation}\" type=\"{\\'number\\'}\">', '', '', function(opts) {\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/number.tag?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('tree', '<virtual each=\"{child in children}\"> <tree-child data-is=\"{child.type}\" property=\"{child}\" riot-value=\"{get(data, child.path, child.default)}\"> <virtual if=\" {opts.property.children}\"> <tree children=\"{opts.property.children}\" data=\"{parent.data}\"></tree> </virtual> </tree-child> </virtual>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\nthis.children = this.opts.children || [];\nthis.depth = parseInt(this.opts.depth) || 0;\nthis.data = this.opts.data || {};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/tree.tag?");
