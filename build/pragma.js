...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var lodash_defaultTo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/defaultTo */ \"./node_modules/lodash/defaultTo.js\");\n/* harmony import */ var lodash_defaultTo__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_defaultTo__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _mixins_edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../mixins/edit */ \"./src/mixins/edit.js\");\n/* harmony import */ var _mixins_domEvent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../mixins/domEvent */ \"./src/mixins/domEvent.js\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\n\n\nriot.tag2('picker', '<input ref=\"input\" list=\"picker-{_riot_id}-list\" oninput=\"{input}\"> <datalist id=\"picker-{_riot_id}-list\"> <option each=\"{item, key in data()}\" riot-value=\"{key}\"></option> </datalist> <button type=\"button\" onclick=\"{add}\"> Add </button>', '', '', function(opts) {\nthis.mixin(_mixins_edit__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\nthis.mixin(_mixins_domEvent__WEBPACK_IMPORTED_MODULE_3__[\"default\"]);\nconsole.log(this); // TODO: Implement sourcing data via ajax\n\nthis.data = {};\nthis.value = null;\n\nthis.data = function () {\n  return lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.data', {});\n};\n\nthis.input = function (event) {\n  if (!this.data()[event.target.value]) {\n    this.value = null;\n    return;\n  }\n\n  this.value = this.data()[event.target.value];\n};\n\nthis.add = function () {\n  // Only fire an event for a valid selection\n  if (!this.value) {\n    return;\n  } // Fire the event\n\n  var target = lodash_defaultTo__WEBPACK_IMPORTED_MODULE_1___default()(lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.target'), this.opts.property.path);\n  this.triggerDom('add', {\n    name: target,\n    value: this.value\n  }); // Clear the query input\n\n  this.refs.input.value = null;\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://%5Bname%5D/./src/tags/input/picker.tag?");
