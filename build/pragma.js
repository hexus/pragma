...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _mixins_edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../mixins/edit */ \"./src/mixins/edit.js\");\n/* harmony import */ var _mixins_domEvent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../mixins/domEvent */ \"./src/mixins/domEvent.js\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\nriot.tag2('picker', '<input list=\"picker-{_riot_id}-list\" oninput=\"{input}\"> <datalist id=\"picker-{_riot_id}-list\"> <option each=\"{item, key in data}\" riot-value=\"{key}\"></option> </datalist> <button type=\"button\" onclick=\"{add}\"> Add </button>', '', '', function(opts) {\nthis.mixin(_mixins_edit__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\nthis.mixin(_mixins_domEvent__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\nconsole.log(this); // TODO: Read these from opts.property.options\n// TODO: Implement sourcing data via ajax\n\nthis.target = 'spells.list';\nthis.data = {\n  'One': {\n    id: 1,\n    name: 'One'\n  },\n  'Two': {\n    id: 2,\n    name: 'Two'\n  },\n  'Three': {\n    id: 3,\n    name: 'Three'\n  }\n};\nthis.value = null;\n\nthis.input = function (event) {\n  if (!this.data[event.target.value]) {\n    this.value = null;\n    return;\n  }\n\n  this.value = this.data[event.target.value];\n};\n\nthis.add = function (event) {\n  console.log(event); // Only fire an event for a valid selection\n\n  if (!this.value) return;\n  this.triggerDom('add', {\n    name: this.target,\n    value: this.value\n  });\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://%5Bname%5D/./src/tags/input/picker.tag?");
