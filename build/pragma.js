...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('tree', '<virtual each=\"{child, index in children}\"> <virtual if=\"{depth === 0}\"> <fieldset> <legend>{child.name}</legend> <virtual if=\"{child.children}\"> <tree children=\"{child.children}\" depth=\"{depth + 1}\" data=\"{data}\"></tree> </virtual> <virtual if=\"{!child.children}\"> <div> <input name=\"{child.path}\" riot-value=\"{get(data, child.path, child.default)}\"> </div> </virtual> </fieldset> </virtual> <virtual if=\"{depth > 0}\"> <p> <label> <span>{\\'&nbsp; \\'.repeat(depth - 1)} {child.name || child.path}</span> <virtual if=\"{!child.children}\"> <input name=\"{child.path}\" riot-value=\"{get(data, child.path, child.default)}\" disabled=\"{!!child.derivation}\"> </virtual> </label> </p> <virtual if=\"{child.children}\"> <tree children=\"{child.children}\" depth=\"{depth + 1}\" data=\"{data}\"></tree> </virtual> </virtual> </virtual>', '', '', function(opts) {\nthis.get = lodash_get__WEBPACK_IMPORTED_MODULE_0___default.a;\nthis.children = this.opts.children || [];\nthis.depth = parseInt(this.opts.depth) || 0;\nthis.data = this.opts.data || {};\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/tree.tag?");
