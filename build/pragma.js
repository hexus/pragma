...
eval("\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    riot.tag2('string', '<input type=\"text\" name=\"{opts.property.path}\" title=\"{opts.property.name}\" riot-value=\"{opts.riotValue}\" disabled=\"{!!opts.property.derivation}\">', '', '', function(opts) {\n});\n\n    \n  \n\n//# sourceURL=webpack://pragma/./src/tags/input/string.tag?");
