...
/***/ "./C:/Users/Hex/AppData/Roaming/npm/node_modules/webpack/buildin/global.js":
/*!***********************************!*\
...
eval("/* WEBPACK VAR INJECTION */(function(global) {/** Detect free variable `global` from Node.js. */\nvar freeGlobal = typeof global == 'object' && global && global.Object === Object && global;\n\nmodule.exports = freeGlobal;\n\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! (webpack)/buildin/global.js */ \"./C:/Users/Hex/AppData/Roaming/npm/node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack:///./node_modules/lodash/_freeGlobal.js?");
...
eval("var toString = __webpack_require__(/*! ./toString */ \"./node_modules/lodash/toString.js\");\n\n/**\n * Converts `string`, as a whole, to upper case just like\n * [String#toUpperCase](https://mdn.io/toUpperCase).\n *\n * @static\n * @memberOf _\n * @since 4.0.0\n * @category String\n * @param {string} [string=''] The string to convert.\n * @returns {string} Returns the upper cased string.\n * @example\n *\n * _.toUpper('--foo-bar--');\n * // => '--FOO-BAR--'\n *\n * _.toUpper('fooBar');\n * // => 'FOOBAR'\n *\n * _.toUpper('__foo_bar__');\n * // => '__FOO_BAR__'\n */\nfunction toUpper(value) {\n  return toString(value).toUpperCase();\n}\n\nmodule.exports = toUpper;\n\n\n//# sourceURL=webpack:///./node_modules/lodash/toUpper.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _character_tag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./character.tag */ \"./src/tags/character.tag\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('pragma', '<h1>Pragma</h1> <input type=\"button\" value=\"Force Update\" onmouseup=\"{() => {}}\"> <virtual if=\"{!state.currentCharacter}\"> </virtual> <virtual if=\"{state.currentCharacter}\"> <h2>Character Sheet</h2> <label> <input type=\"checkbox\" name=\"strict\" onchange=\"{change}\"> Strict </label> <character character=\"{state.currentCharacter}\" strict=\"{strict}\"></character> {state.currentCharacter.abilities.cha.score} </virtual>', '', '', function(opts) {\nthis.state = this.opts.app.state;\nthis.store = this.state.store;\nthis.strict = false;\n\nthis.change = function (event) {\n  this.strict = event.currentTarget.checked;\n};\n\nthis.on('mount', function () {});\nthis.on('unmount', function () {\n  this.state = null;\n  this.store = null;\n  this.strict = null;\n  this.change = null;\n});\n});\n\n    \n  \n\n//# sourceURL=webpack:///./src/tags/pragma.tag?");
