...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _pragma_tag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./pragma.tag */ \"./src/tags/pragma.tag\");\n/* harmony import */ var _input_mdc_mdc_number_tag__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./input/mdc/mdc-number.tag */ \"./src/tags/input/mdc/mdc-number.tag\");\n/* harmony import */ var _input_mdc_mdc_string_tag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./input/mdc/mdc-string.tag */ \"./src/tags/input/mdc/mdc-string.tag\");\n/* harmony import */ var _input_mdc_mdc_selection_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./input/mdc/mdc-selection.tag */ \"./src/tags/input/mdc/mdc-selection.tag\");\n/* harmony import */ var _data_fields__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../data/fields */ \"./src/data/fields.js\");\n/* harmony import */ var _model_functions_abilityModifier__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../model/functions/abilityModifier */ \"./src/model/functions/abilityModifier.js\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\n\n\n\n\nriot.tag2('character-sheet', '<pragma debug functions=\"{functions}\" defaults=\"{defaults}\" fields=\"{fields}\" state=\"{state}\"> </pragma>', '', '', function(opts) {\nthis.fields = _data_fields__WEBPACK_IMPORTED_MODULE_4__[\"default\"];\nthis.functions = {\n  abilityModifier: _model_functions_abilityModifier__WEBPACK_IMPORTED_MODULE_5__[\"default\"]\n};\nthis.defaults = {\n  'number': {\n    input: 'mdc-number'\n  },\n  'string': {\n    input: 'mdc-string'\n  },\n  'selection': {\n    input: 'mdc-selection'\n  }\n};\n\nthis.sync = function () {\n  this.state = this.opts.state || this.root.state || {};\n};\n\nthis.on('mount', this.sync);\nthis.on('update', this.sync);\n\nthis.root.sync = () => {\n  this.sync();\n};\n\nthis.root.update = () => {\n  this.update();\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://%5Bname%5D/./src/tags/character-sheet.tag?");
...
/***/ "./src/tags/input/mdc/mdc-number.tag":
/*!*******************************************!*\
  !*** ./src/tags/input/mdc/mdc-number.tag ***!
  \*******************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _mixins_edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../mixins/edit */ \"./src/mixins/edit.js\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('mdc-number', '<label class=\"mdc-text-field\"> <input name=\"{opts.property.path}\" title=\"{opts.property.name}\" min=\"{opts.property.options.min}\" max=\"{opts.property.options.max}\" step=\"{opts.property.options.step}\" riot-value=\"{opts.property.value}\" disabled=\"{opts.property.disabled}\" oninput=\"{edit}\" class=\"mdc-text-field__input {mdc-text-field--disabled: opts.property.disabled}\" type=\"{\\'number\\'}\"> <span class=\"mdc-floating-label\">{opts.property.name}</span> <div class=\"mdc-line-ripple\"></div> </label>', '', '', function(opts) {\nthis.mixin(_mixins_edit__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n});\n\n    \n  \n\n//# sourceURL=webpack://%5Bname%5D/./src/tags/input/mdc/mdc-number.tag?");

/***/ }),

/***/ "./src/tags/input/mdc/mdc-selection.tag":
/*!**********************************************!*\
  !*** ./src/tags/input/mdc/mdc-selection.tag ***!
  \**********************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ \"./node_modules/lodash/get.js\");\n/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _mixins_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../mixins/edit */ \"./src/mixins/edit.js\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \n\nriot.tag2('mdc-selection', '<label class=\"mdc-select\"> <i class=\"mdc-select__dropdown-icon\"></i> <select name=\"{opts.property.path}\" title=\"{opts.property.name}\" disabled=\"{!!opts.property.disabled}\" oninput=\"{edit}\" class=\"mdc-select__native-control\"> <option each=\"{name, value in getSelectionOptions()}\" riot-value=\"{value}\" selected=\"{opts.property.value === value}\">{name}</option> </select> <span class=\"mdc-floating-label\">{opts.property.name}</span> <div class=\"mdc-line-ripple\"></div> </label>', '', '', function(opts) {\nthis.mixin(_mixins_edit__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\n\nthis.getSelectionOptions = function () {\n  // TODO: Support arrays *and* objects, convert objects to arrays or\n  //       vice versa (remember arrays are faster in riot)\n  return lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(this.opts.property, 'options.options', {});\n};\n});\n\n    \n  \n\n//# sourceURL=webpack://%5Bname%5D/./src/tags/input/mdc/mdc-selection.tag?");

/***/ }),

/***/ "./src/tags/input/mdc/mdc-string.tag":
/*!*******************************************!*\
  !*** ./src/tags/input/mdc/mdc-string.tag ***!
  \*******************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _mixins_edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../mixins/edit */ \"./src/mixins/edit.js\");\n\n    var riot = __webpack_require__(/*! riot */ \"./node_modules/riot/riot.js\")\n    \nriot.tag2('mdc-string', '<label class=\"mdc-text-field\"> <input type=\"text\" name=\"{opts.property.path}\" title=\"{opts.property.name}\" riot-value=\"{opts.property.value}\" disabled=\"{opts.property.disabled}\" oninput=\"{edit}\" class=\"mdc-text-field__input {mdc-text-field--disabled: opts.property.disabled}\"> <span class=\"mdc-floating-label\">{opts.property.name}</span> <div class=\"mdc-line-ripple\"></div> </label>', '', '', function(opts) {\nthis.mixin(_mixins_edit__WEBPACK_IMPORTED_MODULE_0__[\"default\"]);\n});\n\n    \n  \n\n//# sourceURL=webpack://%5Bname%5D/./src/tags/input/mdc/mdc-string.tag?");
