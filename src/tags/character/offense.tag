<offense>
	<fieldset>
		...
		<p>
			...
			<input type="number" name="initiative.abilityModifier" min="-60" max="60" step="1" value="{ offense.initiative.abilityModifier }" onkeyup="{ edit }" onchange="{ edit }"/>
		...
		<p>
			...
			=
			<input type="number" name="combatManeuverBonus.baseAttackBonus" min="-100" max="100" step="1" value="{ offense.combatManeuverBonus.baseAttackBonus }" onkeyup="{ edit }" onchange="{ edit }"/>
			+
			...
			+
			<input type="number" name="combatManeuverBonus.sizeModifier" min="0" max="100" step="1" value="{ offense.combatManeuverBonus.sizeModifier }" onkeyup="{ edit }" onchange="{ edit }"/>
			+
